...
///////////////////////////////// Start Bayar Tunai ///////////////////////////////////
	...
	$(document).on("click", ".bayar-tunai", function() {
		...
		$.ajax({
			...
			data: {idUser: id, tagihan: tagih, daya: daya}
		})
		.error(function(data){
		...
		.done(function(data) {
			...
			$('.msg').html(out.msg);
			effect_msg();
			setTimeout(function() { window.location = "<?php echo base_url('home'); ?>" }, 5000);
		})
	})
////////////////////////////////// End Bayar Tunai ////////////////////////////////////
