...
CREATE TABLE `m_bed` (
  ...
  `status` enum('kosong','terisi','perbaikan','siapkrs','pesan') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('BD001001002', 'RU001', 'KL001', 'TRIBHUWANA-VVIP-02', 'terisi'),
...
CREATE TABLE `m_kelas` (
  `id_kelas` varchar(6) NOT NULL,
  `id_aplicare` varchar(7) NOT NULL,
...
INSERT INTO `m_kelas` (`id_kelas`, `id_aplicare`, `nama_kelas`) VALUES
('KL001', 'VVIP', 'VVIP'),
('KL002', 'VIP', 'VIP'),
('KL003', 'KL1', 'KELAS 1'),
('KL004', 'KL2', 'KELAS 2'),
...
INSERT INTO `m_ruangan` (`id_ruang`, `kode_ruang`, `nama_ruang`) VALUES
...
('US001', 'RU001', 'LV001', 'it', '0192023a7bbd73250516f069df18b500', 'jodipan_kotak.jpg'),
('US002', 'RU002', 'LV002', 'trbw', 'eb1839376a7ded7f79de0585688b4a4a', 'profil3.png');
