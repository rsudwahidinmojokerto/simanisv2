...
<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  <div class="modal-header">
    ...
    <h3 style="display:block; text-align:center;">Update Data Administrator</h3>
  </div>
  ...
  <div class="modal-body">
    <div class="input-group form-group">
      ...
      <input type="hidden" class="form-control" name="id" aria-describedby="sizing-addon2" value="<?php echo $dataAdmin->idUser; ?>">
      <input type="text" class="form-control" placeholder="Masukkan ID" aria-describedby="sizing-addon2" value="<?php echo $dataAdmin->idUser; ?>" disabled>
    </div>
    <div class="input-group form-group">
      <span class="input-group-addon">
        <i class="fa fa-address-card-o"></i>
      </span>
      <input type="text" class="form-control" placeholder="Masukkan NIK" name="nik" aria-describedby="sizing-addon2" value="<?php echo $dataAdmin->nik; ?>">
    </div>
    <div class="input-group form-group">
      <span class="input-group-addon">
        <i class="fa fa-user"></i>
      </span>
      <input type="text" class="form-control" placeholder="Masukkan nama lengkap" name="nama" aria-describedby="sizing-addon2" value="<?php echo $dataAdmin->nama; ?>">
    </div>
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Masukkan e-mail" name="email" aria-describedby="sizing-addon2" value="<?php echo $dataAdmin->email; ?>">
    </div>
    <div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
        <i class="fa fa-mobile-phone"></i>
      </span>
      <input type="text" class="form-control" placeholder="Masukkan nomor telepon" name="telepon" aria-describedby="sizing-addon2" value="<?php echo $dataAdmin->telepon; ?>">
    </div>
  </div>
