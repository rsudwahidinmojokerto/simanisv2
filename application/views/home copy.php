                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002002003->status == 'kosong') ? 'green' : (($bedBD002002003->status == 'terisi') ? 'purple' : (($bedBD002002003->status == 'perbaikan') ? 'yellow' : (($bedBD002002003->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002002003" id="BD002002003"><?php echo ($bedBD002002003->status == 'kosong') ? 'Kosong' : (($bedBD002002003->status == 'terisi') ? 'Terisi' : (($bedBD002002003->status == 'perbaikan') ? 'Perbaikan' : (($bedBD002002003->status == 'siapkrs') ? 'Siap KRS' : "Siap MRS"))); ?></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002002002->status == 'kosong') ? 'green' : (($bedBD002002002->status == 'terisi') ? 'purple' : (($bedBD002002002->status == 'perbaikan') ? 'yellow' : (($bedBD002002002->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002002002" id="BD002002002"><?php echo ($bedBD002002002->status == 'kosong') ? 'Kosong' : (($bedBD002002002->status == 'terisi') ? 'Terisi' : (($bedBD002002002->status == 'perbaikan') ? 'Perbaikan' : (($bedBD002002002->status == 'siapkrs') ? 'Siap KRS' : "Siap MRS"))); ?></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002002004->status == 'kosong') ? 'green' : (($bedBD002002004->status == 'terisi') ? 'purple' : (($bedBD002002004->status == 'perbaikan') ? 'yellow' : (($bedBD002002004->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002002004" id="BD002002004"><?php echo ($bedBD002002004->status == 'kosong') ? 'Kosong' : (($bedBD002002004->status == 'terisi') ? 'Terisi' : (($bedBD002002004->status == 'perbaikan') ? 'Perbaikan' : (($bedBD002002004->status == 'siapkrs') ? 'Siap KRS' : "Siap MRS"))); ?></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002002006->status == 'kosong') ? 'green' : (($bedBD002002006->status == 'terisi') ? 'purple' : (($bedBD002002006->status == 'perbaikan') ? 'yellow' : (($bedBD002002006->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002002006" id="BD002002006"><?php echo ($bedBD002002006->status == 'kosong') ? 'Kosong' : (($bedBD002002006->status == 'terisi') ? 'Terisi' : (($bedBD002002006->status == 'perbaikan') ? 'Perbaikan' : (($bedBD002002006->status == 'siapkrs') ? 'Siap KRS' : "Siap MRS"))); ?></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004003->status == 'kosong') ? 'green' : (($bedBD002004003->status == 'terisi') ? 'purple' : (($bedBD002004003->status == 'perbaikan') ? 'yellow' : (($bedBD002004003->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004003" id="BD002004003"></button>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004004->status == 'kosong') ? 'green' : (($bedBD002004004->status == 'terisi') ? 'purple' : (($bedBD002004004->status == 'perbaikan') ? 'yellow' : (($bedBD002004004->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004004" id="BD002004004"></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004007->status == 'kosong') ? 'green' : (($bedBD002004007->status == 'terisi') ? 'purple' : (($bedBD002004007->status == 'perbaikan') ? 'yellow' : (($bedBD002004007->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004007" id="BD002004007"></button>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004008->status == 'kosong') ? 'green' : (($bedBD002004008->status == 'terisi') ? 'purple' : (($bedBD002004008->status == 'perbaikan') ? 'yellow' : (($bedBD002004008->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004008" id="BD002004008"></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004011->status == 'kosong') ? 'green' : (($bedBD002004011->status == 'terisi') ? 'purple' : (($bedBD002004011->status == 'perbaikan') ? 'yellow' : (($bedBD002004011->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004011" id="BD002004011"></button>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004012->status == 'kosong') ? 'green' : (($bedBD002004012->status == 'terisi') ? 'purple' : (($bedBD002004012->status == 'perbaikan') ? 'yellow' : (($bedBD002004012->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004012" id="BD002004012"></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004001->status == 'kosong') ? 'green' : (($bedBD002004001->status == 'terisi') ? 'purple' : (($bedBD002004001->status == 'perbaikan') ? 'yellow' : (($bedBD002004001->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004001" id="BD002004001"></button>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004002->status == 'kosong') ? 'green' : (($bedBD002004002->status == 'terisi') ? 'purple' : (($bedBD002004002->status == 'perbaikan') ? 'yellow' : (($bedBD002004002->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004002" id="BD002004002"></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004005->status == 'kosong') ? 'green' : (($bedBD002004005->status == 'terisi') ? 'purple' : (($bedBD002004005->status == 'perbaikan') ? 'yellow' : (($bedBD002004005->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004005" id="BD002004005"></button>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004006->status == 'kosong') ? 'green' : (($bedBD002004006->status == 'terisi') ? 'purple' : (($bedBD002004006->status == 'perbaikan') ? 'yellow' : (($bedBD002004006->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004006" id="BD002004006"></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004009->status == 'kosong') ? 'green' : (($bedBD002004009->status == 'terisi') ? 'purple' : (($bedBD002004009->status == 'perbaikan') ? 'yellow' : (($bedBD002004009->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004009" id="BD002004009"></button>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002004010->status == 'kosong') ? 'green' : (($bedBD002004010->status == 'terisi') ? 'purple' : (($bedBD002004010->status == 'perbaikan') ? 'yellow' : (($bedBD002004010->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002004010" id="BD002004010"></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002015003->status == 'kosong') ? 'green' : (($bedBD002015003->status == 'terisi') ? 'purple' : (($bedBD002015003->status == 'perbaikan') ? 'yellow' : (($bedBD002015003->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002015003" id="BD002015003"></button>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002015004->status == 'kosong') ? 'green' : (($bedBD002015004->status == 'terisi') ? 'purple' : (($bedBD002015004->status == 'perbaikan') ? 'yellow' : (($bedBD002015004->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002015004" id="BD002015004"></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002015001->status == 'kosong') ? 'green' : (($bedBD002015001->status == 'terisi') ? 'purple' : (($bedBD002015001->status == 'perbaikan') ? 'yellow' : (($bedBD002015001->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002015001" id="BD002015001"></button>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <button class="small-box btn-block gantiStatusBed bg-<?php echo ($bedBD002015002->status == 'kosong') ? 'green' : (($bedBD002015002->status == 'terisi') ? 'purple' : (($bedBD002015002->status == 'perbaikan') ? 'yellow' : (($bedBD002015002->status == 'siapkrs') ? 'aqua' : 'red'))); ?>" style="height: 50px;" data-id="BD002015002" id="BD002015002"></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
